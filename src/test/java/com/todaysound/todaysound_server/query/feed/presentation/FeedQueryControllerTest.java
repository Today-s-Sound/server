...
class FeedQueryControllerTest extends DocumentationTestSupport {
    ...
    @Test
    void 홈_피드_목록을_조회합니다() throws Exception {
        // given

        HomeFeedResponse response1 = new HomeFeedResponse(1L, "피드 내용", "작성자 이름", "2024-06-01T12:00:00", "fe", "1시간 전");
        HomeFeedResponse response2 = new HomeFeedResponse(2L, "또 다른 피드 내용", "다른 작성자", "2024-06-01T11:30:00", "fe2",
                "2시간 전");
        HomeFeedResponse response3 = new HomeFeedResponse(3L, "세 번째 피드 내용", "세 번째 작성자", "2024-06-01T10:00:00", "fe3",
                "3시간 전");
